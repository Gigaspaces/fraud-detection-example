...
public class ProcessorIntegrationTest {
    ...
    public void verifyProcessing() throws Exception {
        ...
        assertEquals("Processing Flag is false, data was not processed", true, result.isProcessed());
        assertEquals("Processing text mismatch", "PROCESSED : " + data.getRawData(), result.getData());
    }
}
